...
functionAtRedraw = function () {
			...
			if ( typeof this != 'undefined' ) {
			 ...
			 ChartIndiciesBar = find("barchart",hightablesObjRedraw.chartTypes)
			 ChartIndiciesBubble = find("bubblechart",hightablesObjRedraw.chartTypes)
			 ChartIndiciesBox = find("boxplot",hightablesObjRedraw.chartTypes)
			 ChartIndiciesLine = find("linechart",hightablesObjRedraw.chartTypes)

			for (j=0;j<ChartIndiciesBar.length;j++)
			{
				hichChartTemp = make2dArrayForHighChartsBar(hightablesObjRedraw.chartColnames,hightablesObjRedraw.data,hightablesObjRedraw.chartIndicies[ChartIndiciesBar[j]],hightablesObjRedraw.nameIndex)
				makeHighChartBar(hichChartTemp,hightablesObjRedraw.chartNames[ChartIndiciesBar[j]])
			}
